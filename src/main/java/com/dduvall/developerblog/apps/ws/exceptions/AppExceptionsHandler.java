package com.dduvall.developerblog.apps.ws.exceptions;

import com.dduvall.developerblog.apps.ws.ui.model.response.ErrorMessage;
...
//    @ExceptionHandler(value = {UserServiceException.class})
//    public ResponseEntity<Object> handleGetUserServiceException(UserServiceException ex, WebRequest request) {
//
//        ErrorMessage errorMessage = new ErrorMessage(new Date(), ex.getMessage());
//
